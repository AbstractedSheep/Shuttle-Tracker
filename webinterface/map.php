...
<script type="text/javascript">
 ...
 $(document).ready(function() {
       ...
       /* add script tag to load google loader api (which dynamically loads their other APIs, like maps */   

                var script = document.createElement("script");

                script.src = "https://www.google.com/jsapi?key=ABQIAAAAOCTHylaOYOTc5g-_pCj8shSvS8Smej8DQ7j_pE7rX2KkSsk7qxQvVVhsMNeDyqo6NAc2ZwJet-r3CA&callback=loadMaps";
    ...
    /* call google loader to load maps api (called via callback in above script load ,when google loader itself finishes loading) */   
